...
export type TUpdateLocationValidator = yup.InferType<
  typeof updateLocationValidator
>;
export type TGetAllLocationsType = yup.InferType<
  typeof getAllLocationsValidator
>;
