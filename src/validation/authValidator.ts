...
export const getAllAdminsValidator = Yup.object()
  .shape({})
...
export const updateAdminValidator = createAdminValidator.omit([
  "password",
  "email",
]);
...
export type TAdminUpdatePasswordType = Yup.InferType<
  typeof adminUpdatePasswordValidator
>;
