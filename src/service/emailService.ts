...
// static async sendWelcomeAdminEmail({ fullName, email, username, password }: BaseMailType & { username: string; password: string }) {
...
//             bullets: [`Username: ${username}`, `Password: ${password}`],
//          },
//          {
//             tag: "p",
...
//          {
//             tag: "p",
//             content: "Thank you for joining the Revlinks Asset Management admin team.",
//          },
//       ];
...
//     static async sendAdminResetPassword({ email, fullName, passwordResetUrl }: BaseMailType & { passwordResetUrl: string }) {
//       const sections: ListSection[] = [
//          {
//             tag: "raw",
